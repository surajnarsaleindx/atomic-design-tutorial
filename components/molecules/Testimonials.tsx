              ...
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-1 flex-col justify-between bg-white p-6 lg:py-8 lg:px-7">
                  ...
                  <div className="mt-8 flex items-center">
                    ...
                    />
                    <div className="ml-4">
                      <p className="font-pj text-base font-bold text-gray-900">Leslie Alexander</p>
              ...
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-1 flex-col justify-between bg-white p-6 lg:py-8 lg:px-7">
                  ...
                  <div className="mt-8 flex items-center">
                    ...
                    />
                    <div className="ml-4">
                      <p className="font-pj text-base font-bold text-gray-900">Jacob Jones</p>
                      <p className="font-pj mt-0.5 text-sm text-gray-600">Digital Marketer</p>
                    </div>
                  </div>
                </div>
              </div>
